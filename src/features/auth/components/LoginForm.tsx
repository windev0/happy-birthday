...
export function LoginForm({
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if (loginType === LOGIN_TYPE.EMAIL_PASSWORD && event.type === "submit") {
            ...
            <div className="grid gap-6">
              <div className="flex flex-col gap-4">
                <Button
                  ...
                  className="w-full"
                  onClick={(e) =>
                    handleSubmit(LOGIN_TYPE.OAUTH, e, OAuthProvider.Apple)
                  } // with Apple
                >
                ...
                <Button
                  ...
                  className="w-full"
                  onClick={(e) =>
                    handleSubmit(LOGIN_TYPE.OAUTH, e, OAuthProvider.Google)
                  } // with Google
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
